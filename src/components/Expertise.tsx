...
const Expertise = () => {
  return (
    <>
      ...
      <div className="flex flex-col items-center w-full px-6 md:px-8 lg:px-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 lg:gap-x-12 md:gap-x-5 md:px-5 lg:px-0 gap-x-16 md:gap-y-10 gap-y-10 lg:gap-y-9 mt-24 w-full max-w-7xl">
          <TechCards
            icon={exp1}
