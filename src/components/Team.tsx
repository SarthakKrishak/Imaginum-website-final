  ...
  const teamMembers = [
    ...
    },
    {
      ...
      customImageClass:
        "lg:object-contain lg:w-full lg:max-h-fit h-full lg:size-[60vw] md:size-[32vw]",
      slinks: [
        { href: "https://x.com/sarthak", icon: x, label: "X" },
        {
    ...
    <section aria-labelledby="team-heading" id="team-home">
      <div className="text-white font-geist font-bold text-2xl md:text-3xl px-6 lg:px-[6rem] md:px-[6.6vw] flex flex-col gap-4 md:mt-36 mt-24 mb-10">
        <div className="flex items-center">
          ...
          <h1
            id="team-heading"
            className="pl-4 md:pl-[1rem] lg:ml-[-0.5rem] font-['Geist'] tracking-wide"
          >
            Our Team
          </h1>
        </div>
      ...
      {/* The Card structure */}
      <div className="items- justify-center grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 lg:ml-[2.6vw] md:ml-0 px-[12vw] gap-6 lg:gap-0 md:px-[6.6vw]">
          ...
          >
            <div className="relative bg-[#f1f1f1] h-[220px] flex justify-center items-end px-4 overflow-hidden">
              ...
              <img
                src={member.image}
                alt={member.name}
                className={`${member.customImageClass} transition-transform duration-300 hover:scale-105 ease-in-out`}
                loading="lazy"
              />
            </div>
