...
const TechCards = ({
  ...
  return (
    ...
    >
      <div
        className="rounded-2xl bg-[linear-gradient(15.29deg,#000000_-18.99%,#0055FF_328.64%)] 
  p-6 text-white w-full h-full flex flex-col justify-between min-h-[380px] 
  ...
  hover:shadow-[0_10px_25px_rgba(0,85,255,0.35)] hover:ring-1 hover:ring-[#339DFF]/40 duration-700 ease-in-out"
      >
        ...
        <div className="flex flex-col gap-2 mt-8">
          ...
          hover:scale-105 cursor-default duration-300 ease-linear"
              >
